...
define("dir-main", ["require", "exports", "types"], function (require, exports, types_2) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var Main = (function () {
        function Main(Prefs, Data, DbService, LsService, LSKEYS, $interval, $window, $rootScope) {
            var _this = this;
            this.Prefs = Prefs;
            this.Data = Data;
            ...
            var favs = this.LsService.get(this.LSKEYS.favs);
            if (favs) {
                this.vm.favs = favs;
            }
            else {
            ...
            document.addEventListener('deviceready', function () {
                try {
                    _this.not = _this.$window.cordova.plugins.notification.local;
                }
                catch (error) {
        ...
        Main.prototype.getNotificationTime = function (dateStamp, startInt) {
        ...
        Main.prototype.cancelNotification = function (favTimestamp) {
            if (!this.not) {
                return;
            }
            this.not.cancel(favTimestamp);
        };
        Main.prototype.recheduleAllNotifications = function () {
            var _this = this;
            if (!this.not) {
                return;
            }
            ...
            var allFavIds = Object.keys(this.vm.favs);
            allFavIds.forEach(function (favId) {
                for (var i = 0; i < _this.data.events.length; i++) {
                    var event_1 = _this.data.events[i];
                    if (event_1.title === favId) {
                        var favTimestamp = _this.vm.favs[favId];
